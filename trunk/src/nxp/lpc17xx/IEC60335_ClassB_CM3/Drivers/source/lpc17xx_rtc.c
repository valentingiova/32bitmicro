...
uint32_t RTC_GetAlarmTime (RTC_TypeDef *RTCx, uint32_t Timetype)
{
	...
	case RTC_TIMETYPE_DAYOFYEAR:
		...
		break;
	case RTC_TIMETYPE_MONTH:
		return (RTCx->ALMON & RTC_MONTH_MASK); 		/* FIXME return (RTCx->ALMONTH & RTC_MONTH_MASK); */
		break;
	case RTC_TIMETYPE_YEAR:
...
void RTC_SetFullAlarmTime (RTC_TypeDef *RTCx, RTC_TIME_Type *pFullTime)
{
	...
	RTCx->ALMON = pFullTime->MONTH & RTC_MONTH_MASK;	/* FIXME RTCx->ALMONTH = pFullTime->MONTH & RTC_MONTH_MASK; */
...
void RTC_GetFullAlarmTime (RTC_TypeDef *RTCx, RTC_TIME_Type *pFullTime)
{
	...
	pFullTime->MONTH = RTCx->ALMON & RTC_MONTH_MASK;	/* FIXME pFullTime->MONTH = RTCx->ALMONTH & RTC_MONTH_MASK; */
